<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="YouTubePlaylists.Web.Account.Register" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="YouTube" CssClass="col-md-2 control-label">YouTube</asp:Label>
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="YouTube" CssClass="form-control" />
            </div>
        </div>
