namespace Teleimot.Server.Api.Controllers
{
    ...
    using Teleimot.Server.Api.Providers;
    using Teleimot.Server.Api.Results;
    ...
    using Models.Account.RequestModels;
    using Models.Account.ResponseModels;
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var user = new User() { UserName = model.Email, Email = model.Email, ProvidedUsername = model.Username };
        ...
        private IHttpActionResult GetErrorResult(IdentityResult result)
        {
            ...
            if (!result.Succeeded)
            {
                ...
                if (this.ModelState.IsValid)
                {
                    // No this.ModelState errors are available to send, so just return an empty this.BadRequest.
