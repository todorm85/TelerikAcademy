...
public final class Constants {
    ...
    public static final String EXIT_APPLICATION_COMMAND = "exit";

    public static final String SET_PRODUCT_NAME_COMMAND = "product";
    public static final String ADD_PRODUCT_COMMAND = "add product";
    ...
    public static final String TOKEN_SHARED_PREFERENCE_KEY = "token";
}
